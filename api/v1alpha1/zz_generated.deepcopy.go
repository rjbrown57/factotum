...
func (in *FactotumNamespace) DeepCopyInto(out *FactotumNamespace) {
	*out = *in
	if in.Labels != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FactotumNamespace.
func (in *FactotumNamespace) DeepCopy() *FactotumNamespace {
	if in == nil {
		return nil
	}
	out := new(FactotumNamespace)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NamespaceConfigSpec) DeepCopyInto(out *NamespaceConfigSpec) {
	*out = *in
	...
	if in.Namespaces != nil {
		...
		*out = make([]FactotumNamespace, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
